...
const IMG_HERO  = require("../../assets/pcs_alternative_a_transcash_b272.webp");
const IMG_PCS   = require("../../assets/PCS-Mastercard.webp");
const IMG_TRANS = require("../../assets/echange-transcash.webp");
